  ...
  return (
    <div className={cx("container")}>
        ...
        <div className={cx("relatable_product_area")}>
            ...
            <div className={`row ${cx("while_background", "ar_product_grid")}`}> 
                {resultArray.map((book, index) => ( //khong biet phai xu li index lam sao ?
                  <div className={`col-3 ${cx("while_background", "ar_product_grid")}`}>
            ...
            <div className={cx("while_background", "Xem_them_grid")}>
              <button className={cx("Xem_them_button")} onClick={toggleIsReadMore}>{isReadMore ? "Xem Thêm" : "Rút gọn"}</button>
            </div>
        </div>
